...
enum ARROW_POSITION { LEFT, CENTER, RIGHT }
...
var arrow_position := ARROW_POSITION.LEFT:
	set(value):
...
func start(dialogue_resource: DialogueResource, title: String, extra_game_states: Array = []) -> void:
	...
	for character_name in dialogue_resource.character_names:
		...
		var character = ArrayExtension.find_first(dialogue_characters, func(dialogue_character: Personagem):
...
func remove():
	...
	animation_player.animation_finished.connect(func(name): if name == "popup": queue_free())
